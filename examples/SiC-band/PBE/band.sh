...
${VASPMATE_DIR}/VASPMATE --ka3d -par 20
#>>> create POSCAR file
cp STD3POS POSCAR
cp POSCAR INPOS
...
cp incar_rlx INCAR
#>>> correct parameters
#${VASPMATE_DIR}/VASPMATE --ia ISPIN 2
#${VASPMATE_DIR}/VASPMATE --ia ENCUT 400
#>>> create KPOINTS file
...
cp CONTCAR INPOS
cp incar_stc INCAR
${VASPMATE_DIR}/VASPMATE --ia LCHARG T
#${VASPMATE_DIR}/VASPMATE --ia ISPIN 2
#${VASPMATE_DIR}/VASPMATE --ia ICHARG 2
${VASPMATE_DIR}/VASPMATE --ka -par 4000 G
cp NEWKPT KPOINTS
cp INPOS POSCAR
