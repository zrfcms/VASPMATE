...
class Fl_Chart_SVMOD{
	...
	void add(int n, vector<int> x, vector<double> y,const char name[1024]="No Label",unsigned col=FL_BLACK,int linestyle=FL_SOLID,int linewidth=2,int symbol=FL_NO_SYMBOL_SVMOD,int symbol_size=3);
